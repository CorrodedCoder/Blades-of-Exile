...
const item_record_type& ItemSource::weapon(short loot,short level) const
{
	if (loot == 0)
		return null_item;
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::OneHandedWeapon, item_variety::TwoHandedWeapon, item_variety::Invalid);
}
...
const item_record_type& ItemSource::armor(short loot,short level) const
{
	if (loot == 0)
		return null_item;
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Armor, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::helm(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Helm, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::gloves(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Gloves, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::boots(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Boots, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::shield(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Shield, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::potion(short loot) const
{
	if (rand_short(0,80) < 20 * (4 - loot))
		return item_of_type(loot,loot_min[loot],loot_max[loot] / 2, item_variety::PotionOrMagicItem, item_variety::Invalid, item_variety::Invalid);
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::PotionOrMagicItem, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::scroll(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::ScrollOrMagicItem, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::missile(short loot) const
{
	if (rand_short(0,2) < 2)
		return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Arrows, item_variety::ThrownMissile, item_variety::Bow);
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Crossbow, item_variety::Bolts, item_variety::MissileWeapon);
}

const item_record_type& ItemSource::poison(short loot,short level) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::WeaponPoison, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::wand(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Wand, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::ring(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Ring, item_variety::Invalid, item_variety::Invalid);
}

const item_record_type& ItemSource::necklace(short loot) const
{
	return item_of_type(loot,loot_min[loot],loot_max[loot], item_variety::Necklace, item_variety::Invalid, item_variety::Invalid);
} 
