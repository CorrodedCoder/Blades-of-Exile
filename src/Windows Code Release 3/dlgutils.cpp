...
const short heal_costs[9] = {50,30,80,100,250,500,1000,3000,100};
const long cost_mult[7] = {5,7,10,13,16,20,25};
...
void put_scen_info()
{
	short i;
	char place_str[256];
	const char * const ratings[] = {"G","PG","R","NC-17"};
	const char * const difficulty[] = {"Low","Medium","High","Very High"};
