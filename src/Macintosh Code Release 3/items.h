...
void put_pc_effects_on_dialog(DialogPtr dialog,short item);
void draw_help_dialog_item_buttons(DialogPtr dialog,short item);
void draw_help_dialog_forcefields(DialogPtr dialog,short item);
